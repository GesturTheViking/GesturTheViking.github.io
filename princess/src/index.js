...
gameScene.Boot.prototype = {
    ...
    create: function () {
        ...
        /* Sound */
        {
            ...
            this.sounds.microVaggKollision1 = this.sound.add("microVaggKollision1").setVolume(0.3);
            this.sounds.microVaggKollision2 = this.sound.add("microVaggKollision2").setVolume(0.3);
            this.sounds.microVaggKollision3 = this.sound.add("microVaggKollision3").setVolume(0.3);
